        ...
        <section class="row">
            <div class="col-12 col-lg-9">
                ...
                <div class="row user-select-none">
                    ...
                    <div class="col-6 col-lg-3 col-md-6">
                        <a style="cursor: pointer" onclick="window.location.href='/dashboard/users?status=petugas'">
                            <div class="card">
                                <div class="px-4 card-body py-4-5">
                                    <div class="row">
                                        <div class="col-md-4 col-lg-12 col-xl-12 col-xxl-5 d-flex justify-content-start">
                    ...
                    <div class="col-6 col-lg-3 col-md-6">
                        <a style="cursor: pointer" onclick="window.location.href='/dashboard/users?status=peminjam'">
                            <div class="card">
                                <div class="px-4 card-body py-4-5">
                                    <div class="row">
                                        <div class="col-md-4 col-lg-12 col-xl-12 col-xxl-5 d-flex justify-content-start">
                        ...
                        @forelse ($receipts as $receipt)
                            <a href="#" data-bs-toggle="modal"
                                ...
                                <div class="px-4 py-3 recent-message d-flex">
                                    ...
                                    <div class="name ms-4">
                                        <h5 class="mb-1">{{ $receipt->user->nama_lengkap }}</h5>
                                        <h6 class="mb-0 text-muted">
